!(function () {
  ...
  function r(t, a) {
    const n = s;
    let o = [a];
    (t.fetch?.body && o.push(t.fetch.body), t.websocket?.channel && o.push(t.websocket.channel), e.call(n, { message: t, port: a }, o));
  }
  function l(t) {
    t.onmessage = async (t) => {
      const l = t.data.port,
              ...
              const [s, o] = n.connect(
                ...
                (a) => {
                  a instanceof ArrayBuffer
                    ...
                    : e.call(t.websocket.channel, { type: 'message', args: [a] });
                },
                (a, n) => {
